-- Adds payment_method to the route/stop breakdown so daily-pass rows
-- can show it (instapay = paid & confirmed, cash = needs collecting
-- on board). Must drop first: adding a column changes the return type.
